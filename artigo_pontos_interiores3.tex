...
\begin{maxi}
 ...
 \breakObjective{ - \sum_{i=1}^{I} P^{fix}_{op_i} \cdot a_{op_{i,t}} \cdot Q_{op_{i,t}} - \sum_{i=1}^{I} CVU_i \cdot a_{op_{i,t}} \cdot G_{op_{i,t}} \} }
